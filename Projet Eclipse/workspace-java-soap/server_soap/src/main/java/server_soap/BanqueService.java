...
public class BanqueService {
	...
	synchronized public long createAccount(@WebParam(name="montant")double i_dbl_soldeInitial) {
	...
	synchronized public void updateCompte(
			/* LONG CODE COMPTE A MODIFIER 	*/ @WebParam(name="code")long 	i_long_code,
			/* DBL NOUVEAU SOLDE			*/ @WebParam(name="solde")double 	i_double_nouveauSolde
			) throws Exception {
	...
	@WebMethod
	synchronized public void deleteCompte(
			/* LONG CODE COMPTE A MODIFIER 	*/ @WebParam(name="code")long i_long_code
			) throws Exception {
	...
	public void deleteAllAccounts() throws Exception {
		synchronized (m_ArrayList_listeComptes) {

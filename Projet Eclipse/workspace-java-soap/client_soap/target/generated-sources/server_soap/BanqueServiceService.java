 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://server_soap/", wsdlLocation = "http://localhost:8585/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUESERVICESERVICE_QNAME = new QName("http://server_soap/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://server_soap/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server_soap/", "BanqueWSPort"), BanqueWS.class, features);
    }
